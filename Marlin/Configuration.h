...
#define CUSTOM_MACHINE_NAME "Makergear M3-ID Rev.1"
...
#define HOTEND_OFFSET_X { 0.0, 250.77 } // (mm) relative X-offset for each nozzle
 ...
 */
  ...
  #define MPC_BLOCK_HEAT_CAPACITY { 14.98f }           // (J/K) Heat block heat capacities.
  #define MPC_SENSOR_RESPONSIVENESS { 0.2177f }         // (K/s per ∆K) Rate of change of sensor temperature from heat block.
  #define MPC_AMBIENT_XFER_COEFF { 0.0675f }           // (W/K) Heat transfer coefficients from heat block to room air with fan off.
  #if ENABLED(MPC_INCLUDE_FAN)
    #define MPC_AMBIENT_XFER_COEFF_FAN255 { 0.0857f }  // (W/K) Heat transfer coefficients from heat block to room air with fan on full.
  #endif
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.77, 80.77, 1011.41, 458.47 }
...
#define LIMITED_MAX_ACCEL_EDITING     // Limit edit via M201 or LCD to DEFAULT_MAX_ACCELERATION * 2
  ...
  #define MAX_ACCEL_EDIT_VALUES       { 1200, 1200, 10, 2000 } // ...or, set your own edit limits
#endif
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { 100, 110, 100 }
