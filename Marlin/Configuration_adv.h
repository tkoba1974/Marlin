...
#define DUAL_X_CARRIAGE
  ...
  #define X2_MIN_POS    23        // A min coordinate so the X2 carriage can't hit the parked X1 carriage
  #define X2_MAX_POS  250.77      // The max position of the X2 carriage, typically also the home position
  #define X2_HOME_DIR    1        // Set to 1. The X2 carriage always homes to the max endstop position
  #define X2_HOME_POS 250.77  // Default X2 home position. Set to X2_MAX_POS.
...
#define INPUT_SHAPING_Y
    ...
    #define SHAPING_FREQ_X  23.55          // (Hz) The default dominant resonant frequency on the X axis.
    #define SHAPING_ZETA_X  0.15f       // Damping ratio of the X axis (range: 0.0 = no damping to 1.0 = critical damping).
  #endif
  #if ENABLED(INPUT_SHAPING_Y)
    #define SHAPING_FREQ_Y  21.78          // (Hz) The default dominant resonant frequency on the Y axis.
...
#define DIGIPOT_MOTOR_CURRENT { 100,100,190,95,100 }   // Values 0-255 (RAMBO 135 = ~0.75A, 185 = ~1A)
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define FILAMENT_CHANGE_UNLOAD_ACCEL      2000  // (mm/s^2) Lower acceleration may allow a faster feedrate.
  ...
  #define FILAMENT_CHANGE_FAST_LOAD_ACCEL   2000  // (mm/s^2) Lower acceleration may allow a faster feedrate.
...
#define FILAMENT_WIDTH_SENSOR
  ...
  #define MEASUREMENT_DELAY_CM         11    // (cm) The distance from the filament sensor to the melting chamber
