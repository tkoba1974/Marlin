 ...
 */
  ...
  #define X2_MIN_POS CONF_X_T1_MIN       // Set a minimum to ensure the  second X-carriage can't hit the parked first X-carriage
  #define X2_MAX_POS CONF_X_T1_MAX-(X_MIN_POS)       // Set this to the distance between toolheads when both heads are homed
  #define X2_HOME_DIR    1       // Set to 1. The second X-carriage always homes to the maximum endstop position
  #define X2_HOME_POS CONF_X_T1_MAX // Default X2 home position. Set to X2_MAX_POS.
...
#define DIGIPOT_MOTOR_CURRENT { X_T0_MOTOR_CURRENT,Y_MOTOR_CURRENT,Z_MOTOR_CURRENT,E_MOTOR_CURRENT,X_T0_MOTOR_CURRENT }   // Values 0-255 (RAMBO 135 = ~0.75A, 185 = ~1A)
 ...
 */
  ...
  #define TOOLCHANGE_ZRAISE                 CONF_TOOLCHANGE_PARK_ZLIFT // (mm)
